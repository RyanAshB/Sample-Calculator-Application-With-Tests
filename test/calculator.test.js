...
describe('Calculator', function() {
  ...
  it('should return 25 for 10 + 15', function() {
    document.getElementById('x').value = 10;
  ...
  it('should return 0', function() {
    document.getElementById('memoryRec').dispatchEvent(new MouseEvent('dblclick'));
  ...
  it('should return ""', function() {
    ...
    expect(document.getElementById('x').innerHTML).toBe('');
    expect(document.getElementById('y').innerHTML).toBe('');
    expect(document.getElementById('z').innerHTML).toBe('');
  });
